...
** 解决安装MySQL-python报错'my_config.h' file not found的问题 <2019-07-21 日 01:21>
解决方法参考：
- [[https://stackoverflow.com/questions/12218229/my-config-h-file-not-found-when-intall-mysql-python-on-osx-10-8]["my_config.h" file not found when intall mysql-python on osx 10.8 - Stack Overflow]]
...
但是有一点不一样，那就要把/usr/local/bin/mysql_config文件的libs那一行改
成：
#+BEGIN_SRC sh
