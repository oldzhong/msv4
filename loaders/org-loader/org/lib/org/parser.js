...
var lastCaptionDirectiveNode = undefined;
...
Parser.prototype = {
  ...
  parseDirective: function () {
    ...
    if (directiveNode.directiveName === 'caption:') {
      lastCaptionDirectiveNode = directiveNode
    }
...
InlineParser.prototype = {
  ...
  parseLink: function (text) {
    ...
    while ((match = linkPattern.exec(text))) {
      ...
      link.src = src;
      if (lastCaptionDirectiveNode != undefined) {
        link.title = lastCaptionDirectiveNode.directiveRawValue
      }
      lastCaptionDirectiveNode = undefined
      if (title) {
